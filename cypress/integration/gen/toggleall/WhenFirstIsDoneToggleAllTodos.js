...
context('WhenFirstIsDoneToggleAllTodos', () => {
    beforeEach(() => {
    ...
    it('allTodosWereSetToDone ', () => {
    	...
    	nonDeterministicValues.push(nonDeterministicValue);
    	AppUtils.httpPut(`/api/test/non-deterministic/system-time?uuid=${testId}_toggle-all&system-time=${new Date('2020-10-10T17:58:37.000Z').toISOString()}`)
    	localStorage.setItem('nonDeterministicValues', JSON.stringify(nonDeterministicValues));
