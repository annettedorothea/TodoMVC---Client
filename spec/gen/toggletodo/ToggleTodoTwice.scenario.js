...
describe("toggletodo.ToggleTodoTwice", function () {
    beforeAll(async function () {
		...
		await ScenarioUtils.addNonDeterministicValueServer(driver, `${testId}_toggle2`, "system-time", new Date('2020-10-10T15:59:37.000Z').toISOString());
		await ScenarioUtils.invokeAction(driver, TodoActionIds.toggleTodo, [`checkbox_${testId}`]);
	...
	it("todoWasSetToOpen", async () => {
		expect(appState.container.todos.todoList, "todoWasSetToOpen").toEqual([
			{ 
