...
module.exports = {
	...
	invokeAction: async function(driver, action, args) {
		...
		if (TodoActionIds.newTodoKeyPressed === action) {
			...
			await driver.findElement(By.id("newTodoInput")).sendKeys(String.fromCharCode(args[0]));
			await this.waitInMillis(500);
		}
		...
		if (TodoActionIds.editedTodoKeyPressed === action) {
			...
			await driver.findElement(By.id("editedTodo")).sendKeys(String.fromCharCode(args[0]));
			await this.waitInMillis(500);
		}
	},
